...
Argus は Slack をインターフェースとして、タスク実行・メール管理・カレンダー操作・SNS コンテンツ生成などを自律的に行うシステムです。pnpm monorepo で 12 パッケージ、1,000 以上のテストを持つ TypeScript プロジェクトで、Railway VPS 上で 24 時間稼働しています。
